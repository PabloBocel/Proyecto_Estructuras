...
namespace Proyecto_Estructuras
{
    ...
    public class CripRSA
    {
        ...
        public string Encriptar(string contraseña)
        {
            ...
            byte[] contraseñaBytes = Encoding.Unicode.GetBytes(contraseña);

            return Convert.ToBase64String(RSApublicKey.Encrypt(contraseñaBytes, false));
        }
        ...
        public string Desencriptar(string contraEncriptada)
        {
            ...
            return Encoding.Unicode.GetString(RSAprivateKey.Decrypt(bytesContraEncriptada, false));
        }
